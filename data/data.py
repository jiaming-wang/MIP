...
from .dataset import Data, Data_test, Data_eval, Data_patch, Data_name
...
def get_data(cfg, data_dir, data_dir_ref, upscale_factor):
    data_dir = join(cfg['data_dir'], data_dir)
    data_dir_ref = join(cfg['data_dir'], data_dir_ref)
    patch_size = cfg['data']['patch_size']
    augmentation = cfg['data']['data_augmentation']
    normalize = cfg['data']['normalize']
    return Data_name(data_dir, data_dir_ref, patch_size, upscale_factor, augmentation, normalize, transform=transform())
